...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Tavvro — Campus laundry, simplified.', description: 'UX research and service design for a more dependable campus laundry experience.', url: '/works/tavvro', images: [{ url: '/tavvro-colour.png', width: 1672, height: 941 }] },
};
